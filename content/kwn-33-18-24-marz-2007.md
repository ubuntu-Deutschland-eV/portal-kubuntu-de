...
### Kubuntu-de.org befragt Jonathan Riddell über KDE 4
...
4 in Kubuntu.
[http://www.kubuntu-de.org/interview-mit-riddell-zu-kde4-englisch](../../../../interview-mit-riddell-zu-kde4-englisch "http://www.kubuntu-de.org/interview-mit-riddell-zu-kde4-englisch")
...
-   Eric Lake  
    ...
    können.
    [https://launchpad.net/\~ericlake](https://launchpad.net/%7Eericlake "https://launchpad.net/~ericlake")
...
-   Tiago Faria  
    ...
    [https://launchpad.net/\~gouki](https://launchpad.net/%7Egouki "https://launchpad.net/~gouki")
...
-   Martin Albisetti  
    ...
    [https://launchpad.net/\~beuno](https://launchpad.net/%7Ebeuno "https://launchpad.net/~beuno")
...
-   David Farning  
    ...
    [https://launchpad.net/\~dfarning](https://launchpad.net/%7Edfarning "https://launchpad.net/~dfarning")
...
-   Morgan Collett  
    ...
    [https://launchpad.net/\~morgan](https://launchpad.net/%7Emorgan "https://launchpad.net/~morgan")
...
-   Cory Kontros  
    ...
    [https://launchpad.net/\~coryisatm/](https://launchpad.net/%7Ecoryisatm/ "https://launchpad.net/~coryisatm/")





### Albin Tonnerre wurde in die MOTU-Gruppe aufgenommen
...
Neuigkeiten aus der Entwicklung {#neuigkeiten-aus-der-entwicklung align="left"}
------------------------------------------------

### Matt Zimmermann bewertet die letzten 2 Monate der zweigeteilten Entwickler- Mailingliste {#matt-zimmermann-bewertet-die-letzten-2-monate-der-zweigeteilten-entwickler--mailingliste align="left"}
...
### Neue Merkmale für Programmfehler, "Bitesize" eingeschlossen {#neue-merkmale-für-programmfehler-bitesize-eingeschlossen align="left"}
...
### Vorschläge in Bezug auf NFS erwünscht {#vorschläge-in-bezug-auf-nfs-erwünscht align="left"}
...
### Mehr Tests für die neuen Effekte der Benutzeroberfläche und die Verwaltung von beschränkten Treibern benötigt {#mehr-tests-für-die-neuen-effekte-der-benutzeroberfläche-und-die-verwaltung-von-beschränkten-treibern-benötigt align="left"}
...
### Neue Sichtungsrichtlinien der Programmfehler für das Kernel Team {#neue-sichtungsrichtlinien-der-programmfehler-für-das-kernel-team align="left"}
...
### Rückverfolgung von Programmfehlern für die Massen {#rückverfolgung-von-programmfehlern-für-die-massen align="left"}
...
### Entwickeln mit Bazaar (bzr) {#entwickeln-mit-bazaar-bzr align="left"}
...
Meetings and Events {#meetings-and-events align="left"}
------------------------------------

### Ubuntu Hug Day ist nun jeden Freitag! {#ubuntu-hug-day-ist-nun-jeden-freitag align="left"}
...
### Effekte in der Ubuntu Benutzeroberfläche {#effekte-in-der-ubuntu-benutzeroberfläche align="left"}
...
[https://launchpad.net/\~ubuntu-desktop-effects](https://launchpad.net/%7Eubuntu-desktop-effects "https://launchpad.net/~ubuntu-desktop-effects")
...
Weitere Ubuntu Nachrichten {#weitere-ubuntu-nachrichten align="left"}
-------------------------------------------
